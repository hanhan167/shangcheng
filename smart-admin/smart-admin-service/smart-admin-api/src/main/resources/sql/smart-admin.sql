...
CREATE TABLE IF NOT EXISTS `t_employee` (
  ...
  `actual_name` varchar(30) CHARACTER SET utf8 DEFAULT NULL COMMENT '员工名称',
...
CREATE TABLE IF NOT EXISTS `t_privilege` (
  ...
  `key` varchar(255) NOT NULL COMMENT '路由name 英文关键字',
...
CREATE TABLE IF NOT EXISTS `t_quartz_task` (
  ...
  `task_params` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '任务参数',
...
CREATE TABLE IF NOT EXISTS `t_role_privilege` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NOT NULL COMMENT '角色id',
  `privilege_key` varchar(255) NOT NULL COMMENT '权限key',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_goods` (
  ...
  `price` decimal(25,0) DEFAULT NULL COMMENT '价格',
